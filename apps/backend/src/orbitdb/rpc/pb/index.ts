...
export namespace RPCRequest {
  ...
  export function codec(): Codec<RPCRequest> {
    if (_codec == null) {
  ...
  export function encode(obj: RPCRequest): Uint8Array {
    return encodeMessage(obj, RPCRequest.codec())
  }

  export function decode(buf: Uint8Array | Uint8ArrayList): RPCRequest {
...
export namespace RPCError {
  ...
  export function codec(): Codec<RPCError> {
    if (_codec == null) {
  ...
  export function encode(obj: RPCError): Uint8Array {
    return encodeMessage(obj, RPCError.codec())
  }

  export function decode(buf: Uint8Array | Uint8ArrayList): RPCError {
...
export namespace RPCResponse {
  ...
  export function codec(): Codec<RPCResponse> {
    if (_codec == null) {
  ...
  export function encode(obj: RPCResponse): Uint8Array {
    return encodeMessage(obj, RPCResponse.codec())
  }

  export function decode(buf: Uint8Array | Uint8ArrayList): RPCResponse {
...
export namespace RPCMessage {
  ...
  export function codec(): Codec<RPCMessage> {
    if (_codec == null) {
      _codec = message<RPCMessage>((obj, w, opts = {}) => {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            case 1:
              obj.request = RPCRequest.codec()
                .decode(reader, reader.uint32())
              break
            case 2:
              obj.response = RPCResponse.codec()
                .decode(reader, reader.uint32())
              break
            default:
              reader.skipType(tag & 7)
  ...
  export function encode(obj: RPCMessage): Uint8Array {
    return encodeMessage(obj, RPCMessage.codec())
  }

  export function decode(buf: Uint8Array | Uint8ArrayList): RPCMessage {
